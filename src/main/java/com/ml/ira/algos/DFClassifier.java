...
public class DFClassifier {
    ...
    private static final Logger log = LoggerFactory.getLogger(DFClassifier.class);
    ...
    public DFClassifier(Path forestPath,
                      Path inputPath,
                      Path datasetPath,
                      Path outputPath,
                      Configuration conf) {
    ...
    private void configureJob(Job job) throws IOException {
        ...
        job.setJarByClass(DFClassifier.class);
    ...
    public void run() throws IOException, ClassNotFoundException, InterruptedException {
        ...
        job.addCacheFile(datasetPath.toUri());

        log.info("Adding the decision forest to the DistributedCache");
        job.addCacheFile(forestPath.toUri());
