...
public class NLinesRecordReader extends RecordReader<LongWritable, Text> {
    private static int NumLinesPerMap = 3;
    ...
    public boolean nextKeyValue() throws IOException, InterruptedException {
        ...
        int newSize = 0;
        for (int i = 0; i < NumLinesPerMap; i++) {
            Text v = new Text();
            while (pos < end) {
    ...
    public int getNumLinesPerMap() {
        return NumLinesPerMap;
    }

    public static void setNumLinesPerMap(int numLinesPerMap) {
        NumLinesPerMap = numLinesPerMap;
    }
